...
export function buildCashPhotoGatewayPayload({ imageBytes, mimeType, branch, year } = {}) {
    ...
    messages: [{
      ...
      content: [
        { type: 'text', text: prompt },
        {
          type: 'image_url',
          image_url: {
            url: `data:${normalizedMimeType};base64,${imageBytes.toString('base64')}`,
            detail: 'high'
          }
        }
      ]
