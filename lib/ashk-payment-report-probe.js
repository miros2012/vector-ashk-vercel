...
import { probeAshkPaymentPeriodCandidates } from './ashk-payment-period-candidate-probe.js';
...
export async function probeAshkPaymentReportDiagnostics({
  ...
  const periodCandidates = await probeAshkPaymentPeriodCandidates({ session, startDate, endDate });
