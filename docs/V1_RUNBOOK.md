...
- просроченная строка `Требует...` с известным остатком активирует одновременно ручную проверку и риск просроченного платежа; неизвестная сумма остаётся пустой, а не превращается в `0`;
