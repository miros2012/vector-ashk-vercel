...
test('hourly continuation workflow runs the guarded runner on schedule and never calls finance write endpoints', () => {
...
test('runner can only push an isolated agent branch and open a pull request', () => {
