...
test('debtor priority lists the largest debtors for problem branches and flags stale ownership', () => {
  ...
  const receivablesValues = [
    ...
    [101,1,'Фармана Салманова','Кумаритова Алина','A','2026-08-01','DRV',50000,5000,45000,45000,'Курс','2026-08-01'],
    [102,1,'Фармана Салманова','Старый Менеджер','B','2026-07-01','DRV',40000,0,40000,40000,'Курс',''],
    [103,1,'Фармана Салманова','Кумаритова Алина','C','2026-08-02','DRV',30000,5000,25000,25000,'Курс','2026-08-02'],
    [201,2,'Сити-Центр','Кузнецова Марина','D','2026-08-03','DRV',30000,0,30000,30000,'Курс','']
  ];
  const planValues = [
